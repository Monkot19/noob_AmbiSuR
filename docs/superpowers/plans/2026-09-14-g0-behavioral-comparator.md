...
**Pre-launch record (2026-09-14):** User-operated no-training preflight on clean `research/core-routing@ff319d5a4ddc35ec48914111899da3146d86fc31` froze ID `g0_schema3_unseen_e0_20260914T080510Z_4fc982625600`. The confirmation JSON is `/root/autodl-tmp/ambisur_diagnostics/g0_schema3_unseen_e0_20260914T080510Z_4fc982625600.confirmation.json`, SHA256 `16ec0f8c9161ec5254c337ab918eda096023af07aceca5e6a2a80a6a823b0ab3`; the independent `.preflight.json` SHA256 is `9f2051937e740bdfbe501601ad51c17eeffc09f52dd0f6f20bd0a13ac920882f`. New run and private-view paths were absent and remain uncreated in the returned output; no training ran. The exact new paths and command are in `findings.md` and the frozen contract. This record does not authorize E0 or mark G0 passed.
