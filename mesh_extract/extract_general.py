...
def render_sets(dataset : ModelParams, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool,
                 max_depth : float, voxel_size : float, sdf_trunc_scale : float, num_cluster: int, use_depth_filter : bool):
    with torch.no_grad():
...
if __name__ == "__main__":
    ...
    render_sets(model.extract(args), args.iteration, pipeline.extract(args), args.skip_train, args.skip_test, args.max_depth, args.voxel_size, args.sdf_trunc_scale, args.num_cluster, args.use_depth_filter)